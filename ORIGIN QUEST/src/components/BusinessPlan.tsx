                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setRevenueData({...revenueData, unitPrice: parseInt(e.target.value)})}
                      ...
                      <div key={index} className="flex items-center space-x-3">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setRevenueData({...revenueData, customers: newCustomers});
                          }}
                        ...
                        <div key={index} className="flex items-center space-x-3">
                          ...
                          <input
                            ...
                            onChange={(e) => {
                              ...
                              newCostData[category][index] = parseInt(e.target.value);
